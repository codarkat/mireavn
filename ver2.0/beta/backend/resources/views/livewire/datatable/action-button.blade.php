...
<div class="d-flex justify-content-end">
															<div class="ms-2">
																<a class="btn btn-sm btn-icon btn-light btn-active-light-primary" wire:click.prevent="action({{$model_id}}, 'edit')">
															...
															<div class="ms-2">
																<a class="btn btn-sm btn-icon btn-light btn-active-light-primary" wire:click.prevent="action({{$model_id}}, 'delete')">
                                                                    <span class="svg-icon svg-icon-5 m-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
