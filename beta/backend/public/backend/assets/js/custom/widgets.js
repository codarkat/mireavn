...
var KTWidgets = function () {
            ...
            var options = {
                ...
                xaxis: {
                    ...
                    crosshairs: {
                        ...
                        position: 'front',
                        stroke: {
                            color: KTUtil.getCssVariableValue('--kt-gray-200'),
                            width: 1,
                            dashArray: 3
                        }
                    },
                ...
                colors: [KTUtil.getCssVariableValue('--kt-primary')],            
                markers: {
                    colors: [KTUtil.getCssVariableValue('--kt-primary-light')],
                    strokeColor: [KTUtil.getCssVariableValue('--kt-primary')],
                    strokeWidth: 3
                }
            };
    ...
    var initChartWidget3 = function(tabSelector, chartSelector, data, initByDefault) {
        ...
        var options = {
            ...
            colors: [KTUtil.getCssVariableValue('--kt-primary')],
            grid: {
                borderColor: KTUtil.getCssVariableValue('--kt-gray-300'),
                strokeDashArray: 4,
                yaxis: {
                    lines: {
                        show: true
