<div class="d-flex justify-content-end">
															<!--begin::Share link-->
															<div class="ms-2">
																<a class="btn btn-sm btn-icon btn-light btn-active-light-primary updateCategory" data-id="{{ $id }}" data-bs-toggle="modal"
                                data-bs-target="#modal_update_category">
															...
															<!--begin::More-->
															<div class="ms-2">
																<a class="btn btn-sm btn-icon btn-light btn-active-light-primary deleteCategory" data-id="{{ $id }}">
